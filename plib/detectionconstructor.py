...
barcode_lut = pd.read_csv(r'C:\Users\Thomas\Documents\Python_and_R\inputdata\barcodes_twentymer_55.csv', header=0).iloc[:,0:2] # remember iloc!!
## this is supplied by user
dye_lut = pd.read_csv(r'C:\Users\Thomas\Documents\Python_and_R\inputdata\dyes.csv', header=0)['Sequence']## these need to be complementary-reversed!
